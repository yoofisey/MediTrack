...
.trans-screen{position:fixed;inset:0;background:linear-gradient(155deg,#1a6cff 0%,#0055CC 45%,#002d80 80%,#001a4d 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;overflow:hidden}
