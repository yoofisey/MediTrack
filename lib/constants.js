...
body{font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue','Segoe UI',sans-serif;color:var(--t1);-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;overscroll-behavior:none;-webkit-touch-callout:none}
...
.btn{display:flex;align-items:center;justify-content:center;gap:6px;padding:12px 18px;border-radius:12px;font-size:15px;font-weight:600;cursor:pointer;border:none;font-family:inherit;transition:all .15s cubic-bezier(.34,1.56,.64,1);position:relative}
...
.input-field{padding:12px 14px;border:1.5px solid var(--sep);border-radius:12px;font-size:16px;color:var(--t1);font-family:inherit;background:var(--input);outline:none;transition:all .15s;box-shadow:0 1px 2px rgba(0,0,0,.02) inset}
...
.auth-card{background:var(--card);border-radius:22px;padding:28px 22px;width:100%;max-width:380px;box-shadow:0 2px 20px rgba(0,0,0,.06);animation:slideUp .45s cubic-bezier(.22,1,.36,1) both}
...
.auth-title{font-size:24px;font-weight:700;margin-bottom:4px;letter-spacing:-.4px}
.auth-sub{font-size:14px;color:var(--t3);margin-bottom:20px;line-height:1.4}
.oauth-stack{display:flex;flex-direction:column;gap:8px;margin-bottom:16px}
.oauth-btn{display:flex;align-items:center;justify-content:center;gap:10px;padding:12px 18px;border:1.5px solid var(--sep);border-radius:12px;background:var(--card);cursor:pointer;font-size:14px;font-weight:500;color:var(--t1);font-family:inherit;transition:all .12s;width:100%}
.oauth-btn:active{background:var(--hover);transform:scale(.98)}
.oauth-btn svg{width:18px;height:18px;flex-shrink:0}
.divider{display:flex;align-items:center;gap:10px;margin-bottom:14px;color:var(--t3);font-size:12px;font-weight:500}
.divider::before,.divider::after{content:'';flex:1;height:0.5px;background:var(--sep)}
.pw-wrap{transition:all .15s}
...
.auth-switch button{background:none;border:none;color:var(--teal);font-weight:600;cursor:pointer;font-size:13px;font-family:inherit;transition:opacity .12s}
.auth-switch button:active{opacity:.6}
.err-msg{background:var(--ib6);border:1px solid rgba(255,59,48,.12);color:var(--red);padding:10px 14px;border-radius:10px;font-size:13px;margin-bottom:14px;line-height:1.4}
.ok-msg{background:var(--ib2);border:1px solid rgba(0,122,255,.12);color:var(--teal);padding:12px 14px;border-radius:10px;font-size:13px;margin-bottom:12px;line-height:1.4}
