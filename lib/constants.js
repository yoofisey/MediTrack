...
.scroll{overflow-x:hidden;padding-bottom:calc(56px + var(--safe-bottom));padding-top:calc(4px + var(--safe-top));max-width:100vw}
...
.auth-screen{min-height:100vh;min-height:100dvh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;padding-top:calc(24px + env(safe-area-inset-top,0px));background:linear-gradient(160deg,#0b1a30 0%,#0d2b5e 30%,#0a1f4a 60%,#061233 100%);position:relative;overflow:hidden}
