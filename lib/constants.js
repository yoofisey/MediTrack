...
.upgrade-card{background:linear-gradient(145deg,var(--teal) 0%,var(--teal2) 100%);border-radius:var(--rxl);padding:28px 24px;color:white;position:relative;overflow:hidden;box-shadow:0 8px 32px rgba(0,122,255,.25)}
...
.upgrade-btn{background:white;color:var(--teal);border:none;border-radius:var(--ios-radii);padding:14px 22px;font-size:16px;font-weight:700;cursor:pointer;font-family:inherit;width:100%;transition:transform .18s cubic-bezier(.34,1.56,.64,1),box-shadow .18s;box-shadow:0 2px 8px rgba(0,0,0,.1)}
