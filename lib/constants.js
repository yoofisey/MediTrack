...
.scroll{overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;padding-bottom:calc(80px + var(--safe-bottom));padding-top:4px;overscroll-behavior:contain;max-width:100vw}
...
.list{background:var(--card);border-radius:var(--rxl);overflow:hidden;box-shadow:var(--card-shadow);position:relative}
.row{display:flex;align-items:center;padding:13px 16px;min-height:46px;gap:12px;cursor:pointer;transition:background .12s ease;position:relative}
...
@media(max-width:374px){.auth-card{padding:24px 16px!important}.input-field,.sheet-input{padding:12px 12px!important;font-size:15px!important}.auth-title{font-size:22px!important}}
