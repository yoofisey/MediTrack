...
.navbar{position:sticky;top:0;z-index:100;background:rgba(249,249,249,0.88);backdrop-filter:blur(40px) saturate(1.8) brightness(1.02);-webkit-backdrop-filter:blur(40px) saturate(1.8) brightness(1.02);border-bottom:0.5px solid rgba(0,0,0,.06);padding:calc(var(--safe-top) + 10px) 20px 8px;display:flex;align-items:flex-end;justify-content:space-between;min-height:56px}
...
.tabbar{position:fixed;bottom:0;left:0;right:0;height:calc(54px + var(--safe-bottom));background:rgba(249,249,249,0.9);backdrop-filter:blur(40px) saturate(1.8) brightness(1.02);-webkit-backdrop-filter:blur(40px) saturate(1.8) brightness(1.02);border-top:0.5px solid rgba(0,0,0,.06);display:flex;align-items:flex-start;padding-top:6px;z-index:200}
...
.upgrade-card{background:linear-gradient(145deg,rgba(0,122,255,.92) 0%,rgba(0,85,204,.95) 100%);border-radius:var(--rxl);padding:28px 24px;color:white;position:relative;overflow:hidden;box-shadow:0 8px 32px rgba(0,122,255,.3),0 0 0 1px rgba(255,255,255,.1) inset;backdrop-filter:blur(20px) saturate(1.6);-webkit-backdrop-filter:blur(20px) saturate(1.6)}
.upgrade-card::before{content:'';position:absolute;top:-50%;right:-20%;width:60%;height:100%;background:radial-gradient(circle,rgba(255,255,255,.1) 0%,transparent 60%);border-radius:50%;pointer-events:none;animation:premiumGlow 6s ease-in-out infinite}
.upgrade-card::after{content:'';position:absolute;inset:0;background:linear-gradient(110deg,transparent 25%,rgba(255,255,255,.08) 50%,transparent 75%);background-size:200% 100%;animation:shimmer 3s infinite;pointer-events:none}
...
.upgrade-btn{background:rgba(255,255,255,.95);color:var(--teal);border:none;border-radius:var(--ios-radii);padding:14px 22px;font-size:16px;font-weight:700;cursor:pointer;font-family:inherit;width:100%;transition:transform .18s cubic-bezier(.34,1.56,.64,1),box-shadow .18s,background .15s;box-shadow:0 4px 16px rgba(0,0,0,.12),0 0 0 1px rgba(255,255,255,.2) inset;backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)}
.upgrade-btn:active{transform:scale(.97);box-shadow:0 2px 8px rgba(0,0,0,.1);background:rgba(255,255,255,1)}

.glass-card{background:rgba(255,255,255,.72);backdrop-filter:blur(24px) saturate(1.8);-webkit-backdrop-filter:blur(24px) saturate(1.8);border:0.5px solid rgba(255,255,255,.6);border-radius:var(--rxl);box-shadow:0 4px 20px rgba(0,0,0,.06),0 0 0 0.5px rgba(0,0,0,.02) inset,0 1px 0 rgba(255,255,255,.5) inset;position:relative;overflow:hidden;transition:box-shadow .25s ease,transform .2s ease}
.glass-card::before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(255,255,255,.25) 0%,rgba(255,255,255,.05) 50%,rgba(255,255,255,.15) 100%);pointer-events:none;border-radius:inherit}
.glass-card:active{box-shadow:0 6px 28px rgba(0,0,0,.08),0 0 0 0.5px rgba(0,0,0,.03) inset,0 1px 0 rgba(255,255,255,.6) inset}

.premium-badge{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:99px;font-size:11px;font-weight:700;letter-spacing:.4px;text-transform:uppercase;background:linear-gradient(135deg,rgba(0,122,255,.12),rgba(0,85,204,.15));color:var(--teal);border:0.5px solid rgba(0,122,255,.2);position:relative;overflow:hidden}
.premium-badge::after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(255,255,255,.3),transparent);background-size:200% 100%;animation:shimmer 4s infinite;pointer-events:none}
...
.chip.on{background:rgba(0,122,255,.08);border-color:var(--teal);color:var(--teal);box-shadow:0 0 0 1px var(--teal)}
