...
.auth-card{background:var(--card);border-radius:24px;padding:36px 28px;width:100%;max-width:380px;box-shadow:0 4px 24px rgba(0,0,0,.06);animation:slideUp .45s cubic-bezier(.22,1,.36,1) both}
...
.oauth-btn{display:flex;align-items:center;justify-content:center;gap:10px;padding:13px 18px;border:0.5px solid var(--sep);border-radius:var(--ios-radii);background:var(--card);cursor:pointer;font-size:15px;font-weight:500;color:var(--t1);font-family:inherit;transition:all .12s;width:100%}
...
.pw-wrap{border-radius:var(--ios-radii);transition:all .18s}
...
.err-msg{background:rgba(255,59,48,.06);border:0.5px solid rgba(255,59,48,.12);color:var(--red);padding:12px 16px;border-radius:var(--ios-radii);font-size:13px;margin-bottom:16px;line-height:1.4}
.ok-msg{background:rgba(0,122,255,.06);border:0.5px solid rgba(0,122,255,.12);color:var(--teal);padding:14px 18px;border-radius:var(--ios-radii);font-size:13px;margin-bottom:14px;line-height:1.4}
...
.trans-screen{position:fixed;inset:0;background:linear-gradient(155deg,#1a6cff 0%,#0055CC 45%,#002d80 80%,#001a4d 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;overflow:hidden;transition:opacity .4s cubic-bezier(.4,0,.2,1)}
.trans-screen::after{content:'';position:absolute;inset:0;background:radial-gradient(ellipse at 50% 40%,transparent 40%,rgba(0,0,0,.18) 100%);pointer-events:none}
.trans-bg-orb{position:absolute;border-radius:50%;pointer-events:none}
@keyframes orbFloat{from{transform:translate(0,0) scale(1)}to{transform:translate(3%,2%) scale(1.05)}}
@keyframes orbFloat2{from{transform:translate(0,0) scale(1)}to{transform:translate(-2%,3%) scale(1.08)}}
@keyframes orbFloat3{from{transform:translate(0,0) scale(1)}to{transform:translate(2%,-2%) scale(1.04)}}
.trans-screen.fade-out{opacity:0;pointer-events:none}
.trans-logo-wrap{position:relative;margin-bottom:20px;animation:logoPop .8s cubic-bezier(.175,.885,.32,1.275) both}
.trans-logo{width:96px;height:96px;background:rgba(255,255,255,.14);border-radius:28px;display:grid;place-items:center;backdrop-filter:blur(20px) saturate(1.4);-webkit-backdrop-filter:blur(20px) saturate(1.4);border:1px solid rgba(255,255,255,.15);box-shadow:0 0 0 1px rgba(255,255,255,.05) inset,0 8px 32px rgba(0,0,0,.12),0 2px 8px rgba(0,0,0,.08),0 0 60px rgba(0,122,255,.12);position:relative;z-index:1}
.trans-logo-ring{position:absolute;inset:-3px;border-radius:31px;background:conic-gradient(from 0deg,transparent 0%,rgba(255,255,255,.2) 25%,transparent 50%,rgba(255,255,255,.15) 75%,transparent 100%);animation:ringRotate 3s linear infinite;z-index:0;opacity:.6}
@keyframes ringRotate{to{transform:rotate(360deg)}}
.trans-logo svg{fill:white;width:48px;height:48px}
.trans-title{font-size:34px;font-weight:700;color:white;animation:fadeUp .6s .15s cubic-bezier(.22,1,.36,1) both;letter-spacing:-.8px;text-shadow:0 1px 3px rgba(0,0,0,.12)}
.trans-msg{font-size:16px;color:rgba(255,255,255,.72);margin-bottom:44px;animation:fadeUp .65s .3s cubic-bezier(.22,1,.36,1) both;text-align:center;padding:0 32px;line-height:1.5;font-weight:400;letter-spacing:-.1px}
.trans-bar-wrap{width:120px;height:3px;background:rgba(255,255,255,.12);border-radius:99px;overflow:hidden;animation:fadeUp .6s .4s cubic-bezier(.22,1,.36,1) both}
.trans-bar-fill{height:100%;border-radius:99px;background:linear-gradient(90deg,rgba(255,255,255,.15),rgba(255,255,255,.6),rgba(255,255,255,.15));background-size:200% 100%;animation:transShimmer 1.6s ease-in-out infinite}
@keyframes transShimmer{0%{background-position:200% 0}100%{background-position:-200% 0}}
.trans-status{font-size:13px;color:rgba(255,255,255,.5);font-weight:500;letter-spacing:.1px;margin-top:14px;animation:fadeUp .5s .55s cubic-bezier(.22,1,.36,1) both;position:relative;height:18px}
.trans-status-inner{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;transition:opacity .35s ease,transform .35s ease}
.trans-status-inner.out{opacity:0;transform:translateY(4px)}
...
@media(max-width:374px){.auth-card{padding:24px 16px!important}.input-field,.sheet-input{padding:12px 12px!important;font-size:16px!important}.auth-title{font-size:22px!important}}
