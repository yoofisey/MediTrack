...
.scroll{overflow-x:hidden;padding-bottom:calc(84px + var(--safe-bottom));padding-top:4px;max-width:100vw}
...
.onboard-screen{min-height:100vh;padding-top:env(safe-area-inset-top,0px);background:var(--bg);display:flex;flex-direction:column}
