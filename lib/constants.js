...
.trans-logo{width:80px;height:80px;background:rgba(255,255,255,.18);border-radius:24px;display:grid;place-items:center;margin-bottom:16px;backdrop-filter:blur(16px);animation:logoPop .7s cubic-bezier(.175,.885,.32,1.275) both,logoPulse 2.4s ease-in-out 1s infinite;border:1px solid rgba(255,255,255,.12);box-shadow:0 8px 32px rgba(0,0,0,.1),0 0 40px rgba(0,122,255,.15);will-change:transform,box-shadow}
.trans-logo svg{fill:white;width:40px;height:40px;animation:svgPulse 2.4s ease-in-out 1s infinite}
.trans-title{font-size:32px;font-weight:800;color:white;animation:fadeUp .5s ease both;letter-spacing:-.5px}
...
.trans-content{animation:fadeUp .5s ease both}
@keyframes logoPop{from{transform:scale(.3) rotate(-8deg);opacity:0}to{transform:scale(1) rotate(0deg);opacity:1}}
@keyframes logoPulse{0%,100%{transform:scale(1);box-shadow:0 8px 32px rgba(0,0,0,.1),0 0 40px rgba(0,122,255,.15)}50%{transform:scale(1.05);box-shadow:0 12px 48px rgba(0,0,0,.15),0 0 60px rgba(0,122,255,.3)}}
@keyframes svgPulse{0%,100%{opacity:1;transform:scale(1)}50%{opacity:.85;transform:scale(.95)}}
