...
html,body{min-height:100%;background:var(--bg);overflow-x:hidden;max-width:100vw}
...
.scroll{overflow-x:hidden;padding-bottom:calc(64px + var(--safe-bottom));padding-top:calc(4px + var(--safe-top));max-width:100vw}
...
.auth-screen{min-height:100vh;min-height:100dvh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;padding-top:calc(24px + env(safe-area-inset-top,0px));padding-bottom:calc(24px + env(safe-area-inset-bottom,0px));background:linear-gradient(160deg,#0b1a30 0%,#0d2b5e 30%,#0a1f4a 60%,#061233 100%);position:relative;overflow-y:auto}
...
.auth-card{background:rgba(255,255,255,.1);backdrop-filter:blur(24px) saturate(1.6);-webkit-backdrop-filter:blur(24px) saturate(1.6);border:1px solid rgba(255,255,255,.12);border-radius:28px;padding:36px 28px;width:100%;max-width:380px;margin:auto 0;box-shadow:0 8px 40px rgba(0,0,0,.15),0 0 0 1px rgba(255,255,255,.05) inset;animation:slideUp .5s cubic-bezier(.22,1,.36,1) both;position:relative;z-index:1}
