...
export const TIER_CONFIG = {
  ...
  pro: {
    ...
    upsell: false,
    features: ["vitals", "reports", "interactionCheck", "refillReminder", "sideEffects", "healthJournal"],
  },
  family: {
    label: "Family",
    badge: "Family",
    ...
    profiles: 5,
    upsell: false,
    features: ["familyMembers", "familyDashboard", "managedProfiles", "perMemberVitals", "perMemberReports", "caregiverAlerts", "vitals", "reports"],
  },
  enterprise: {
    label: "Enterprise",
    badge: "Enterprise",
