...
const VITAL_LABELS = {
  ...
  cholesterol: { label:"Total Cholesterol", icon:"🧪", unit:"mg/dL" },
  bmi: { label:"BMI", icon:"📏", unit:"kg/m²" },
  hba1c: { label:"HbA1c", icon:"🩸", unit:"%" },
  water_intake: { label:"Water Intake", icon:"💧", unit:"L" },
  peak_flow: { label:"Peak Flow", icon:"🫁", unit:"L/min" },
};
