...
function showNotification(title, body, opts = {}) {
  try {
    ...
    if (navigator.serviceWorker?.ready) {
      navigator.serviceWorker.ready.then(r => r.showNotification(title, o)).catch(() => { if (typeof Notification !== 'undefined') new Notification(title, o); });
    } else {
      if (typeof Notification !== 'undefined') new Notification(title, o);
    }
  } catch {}
}
