...
export const BADGES = [
  { id: "first_dose", icon: "💊", title: "First Dose", desc: "Log your first medication dose", category: "getting_started" },
  { id: "streak_3", icon: "🔥", title: "3-Day Streak", desc: "Take all meds for 3 days straight", category: "streak" },
  { id: "streak_7", icon: "⚡", title: "Week Warrior", desc: "7-day perfect streak", category: "streak" },
  { id: "streak_14", icon: "🌟", title: "Fortnight Champion", desc: "14-day streak", category: "streak" },
  { id: "streak_30", icon: "👑", title: "Monthly Master", desc: "30-day streak", category: "streak" },
  { id: "streak_90", icon: "🏆", title: "Quarter Legend", desc: "90-day streak", category: "streak" },
  { id: "journal_5", icon: "📝", title: "Journaler", desc: "Write 5 journal entries", category: "journal" },
  { id: "journal_30", icon: "📖", title: "Diary Devotee", desc: "30 journal entries", category: "journal" },
  { id: "perfect_week", icon: "💎", title: "Perfect Week", desc: "100% adherence for a full week", category: "adherence" },
  { id: "perfect_month", icon: "🎖️", title: "Perfect Month", desc: "100% adherence for 30 days", category: "adherence" },
  { id: "vitals_logger", icon: "🩺", title: "Vitals Pro", desc: "Log 10 vital readings", category: "vitals" },
  { id: "family_caregiver", icon: "❤️", title: "Family Caregiver", desc: "Add a family member", category: "family" },
  { id: "early_bird", icon: "🐦", title: "Early Bird", desc: "Log a dose before 8 AM", category: "special" },
  { id: "night_owl", icon: "🦉", title: "Night Owl", desc: "Log a dose after 10 PM", category: "special" },
];
